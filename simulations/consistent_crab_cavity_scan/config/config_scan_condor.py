...
from htcondor_config import htcondor_config
    
tobecopied = 'transient.job restart.job restart_nobunch.job transient_sim.py restart_sim.py restart_sim_nobunch.py'
...
for i, Emax in enumerate(Emax_vect):
    ...
    rl.replaceline_and_save(fname = current_sim_folder+'/transient.job',
     findln = "CURRDIR=", newline = "CURRDIR=" +current_sim_folder+"\n")

    rl.replaceline_and_save(fname = current_sim_folder+'/restart.job',
     findln = "CURRDIR=", newline = "CURRDIR=" +current_sim_folder+"\n")

    rl.replaceline_and_save(fname = current_sim_folder+'/restart_nobunch.job',
     findln = "CURRDIR=", newline = "CURRDIR=" +current_sim_folder+"\n") 
...
htcondor_config(scan_folder,time_requirement_days = 1., ncpus = NCPUS,
                job_filename = 'transient.job', list_filename = 'list_sim_folders_transient.txt',
                sub_filename = 'transient.sub', out_filename = 'transient.out',
                err_filename = 'transient.err', log_filename = 'transient.log',
                run_filename = 'run_transient_htcondor')

htcondor_config(scan_folder,time_requirement_days = 1., ncpus = NCPUS,
                job_filename = 'restart.job', list_filename = 'list_sim_folders_restart.txt',
                sub_filename = 'restart.sub', out_filename = 'restart.out',
                err_filename = 'restart.err', log_filename = 'restart.log',
                run_filename = 'run_restart_htcondor')

htcondor_config(scan_folder,time_requirement_days = 1., ncpus = NCPUS,
                job_filename = 'restart_nobunch.job', list_filename = 'list_sim_folders_restart_nobunch.txt',
                sub_filename = 'restart_nobunch.sub', out_filename = 'restart_nobunch.out',
                err_filename = 'restart_nobunch.err', log_filename = 'restart_nobunch.log',
                run_filename = 'run_restart_nobunch_htcondor')
